...
public class O1 {
	...
	public static void main(String[] args) {
		...
		float intekkt = input1.nextFloat();
		...
		if (intekkt >= 0 && intekkt <= 208050) {
			...
			skatt = skatt = maxSkatt1 + ((intekkt-292850)* trinn2);
		} else if (intekkt >= 670001 && intekkt <= 937900) {
			skatt = skatt = maxSkatt2 + ((intekkt-670000)* trinn3);
		} else if (intekkt >= 937901 && intekkt <= 1350000) {
			skatt = skatt = maxSkatt3 + ((intekkt-937900)* trinn4);
		} else if (intekkt > 1350001) {
			skatt = skatt = maxSkatt4 + ((intekkt-1350000)* trinn5);
		} else {
